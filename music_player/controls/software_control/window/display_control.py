...
class Display_Control(object):
    ...
    def __init__(self, displayRotation = 0):
        ...
        self.background = Image.open('/home/pi/raspi-music-player/bitmaps/mp3-player-background.bmp')
        #self.grayBg = Image.open('../raspi-music-player/bitmaps/gray-background.bmp')
        self.lowBatteryImage = Image.open('/home/pi/raspi-music-player/bitmaps/lowBattery.bmp')

        self.shutDownImage = Image.open('/home/pi/raspi-music-player/bitmaps/shutDown.bmp')
    ...
    def get_gray_background(self, size):
        ...
        for i in range(int(height/2)):
            background.paste(Image.open('/home/pi/raspi-music-player/bitmaps/gray-background.bmp'), (0, i*2))
        return background
